...
execute if score @s VEUtil.sqrt.field1 matches 1.. run scoreboard players operation @s VEUtil.sqrt.field3 = @s VEUtil.sqrt.field2
execute if score @s VEUtil.sqrt.field1 matches 1.. run function ve:util/sqrt
